...
2. **Estelas (trails) are control variables.** They are not just records of past activity; they are tools for med-term behavioral control.
...
| Area | Decay | Energy | Function |
|------|-------|--------|----------|
| **NAV** | 10% | Low | Reflexes and spatial avoidance |
| **MOT** | 8% | Medium | Hunger, safety, motivation |
| **N+2** | **5%** | **High** | **Constructive instinct** |
